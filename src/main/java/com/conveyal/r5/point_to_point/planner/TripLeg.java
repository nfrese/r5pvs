package com.conveyal.r5.point_to_point.planner;
...
/**
 * copied from https://github.com/ipeaGIT/r5r/ - MIT License
 */
...
//        int alightStopIndex = pattern.stops[state.alightStopPosition];
        ...
        if (isTransit) {
            ...
            legDistance = getLinestringLength(geometry);
        } else {
    ...
    private int getLinestringLength(LineString geometry2) {
		return (int)Math.round(geometry2.getLength());
	}
